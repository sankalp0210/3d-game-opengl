...
Missile::Missile(float x, float y, float z, float r, float h) {
    ...
    objects.push_back(Cylinder(50, 0, h/2, 0, r, r, 0, 0, h/4, COLOR_BLACK));
}
...
void Missile::draw(glm::mat4 VP) {
    ...
    glm::mat4 rotate_y  = glm::rotate((float)(this->rotation.x*M_PI /180.0f), glm::vec3(0, 1, 0));
    glm::mat4 rotate_z  = glm::rotate((float)(this->rotation.x*M_PI /180.0f), glm::vec3(0, 0, 1));
