...
Fuel::Fuel(float x, float y) {
    ...
    this->object[0] = create3DObject(GL_TRIANGLES, 8*3,vertex_buffer_data2, COLOR_FUEL_B, GL_FILL);
    this->object[1] = create3DObject(GL_TRIANGLES, 2*3,vertex_buffer_data1, COLOR_FUEL, GL_FILL);
